...
// Some additional comments follow in individual code segments.  See
// explanations for the required methods in the Assignment 3 document.
public class Assig3B
{
	public static void main(String [] args)
	{
		...
		System.out.println("\nIn '" + b1 + "': ");
		System.out.println(s1 + " was found last at " + i1);
		System.out.println(s2 + " was found last at " + i2);
		System.out.println(s3 + " was found last at " + i3);
		System.out.println();	


		System.out.println("Testing regMatch() method\n");
